...
class Ui_Qpurchase(QtWidgets.QDialog):
    ...
    def updateTable(self):
        ...
        item = QtWidgets.QTableWidgetItem("999")
        ...
        item = QtWidgets.QTableWidgetItem("2022/10/16")
        item.setTextAlignment(Qt.AlignCenter)
        item.setFont(font)
    ...
    def setupUi(self):
        ...
        self.purchase_table.setColumnWidth(0,15)
        self.purchase_table.setColumnWidth(1, 90)
        self.purchase_table.setColumnWidth(2, 90)
        self.purchase_table.setColumnWidth(3, 120)
        self.purchase_table.setColumnWidth(4, 110)
    ...
    def retranslateUi(self):
        ...
        item.setText(_translate("inoutDialog", "id"))
        item.setFont(font)
        ...
        item.setText(_translate("inoutDialog", "ingreso"))
        item.setFont(font)
